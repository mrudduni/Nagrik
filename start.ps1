...
$agentCmd = "Set-Location '$agentBackendDir'; py -m uvicorn app.main:app --reload --port 8000"
$complaintCmd = "Set-Location '$complaintBackendDir'; py -m uvicorn app.main:app --reload --port 8002"
